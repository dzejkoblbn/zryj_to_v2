class UzytkowniksController < ApplicationController
  ...
  private
    ...
    def set_uzytkownik
      @uzytkownik = Uzytkownik.find(params[:index])
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def uzytkownik_params
      params.require(:uzytkownik).permit(:imie, :index, :kod_pocztowy_u, :nazwisko, :nr_budynku_u, :nr_mieszkania_u, :ulica_u, :password, :password_confirmation)
    end
end
